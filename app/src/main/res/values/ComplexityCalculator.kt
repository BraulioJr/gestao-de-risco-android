...
/**
 * Cérebro da Mecânica "Border Collie".
...
object ComplexityCalculator {
    ...
    fun calculate(factors: RiskFactors): ComplexityLevel {
        ...
        // CÁLCULO PONDERADO (A "Alquimia" do Border Collie)
    ...
    fun applyDiminishingReturns(baseXp: Int, dailyCount: Int, complexity: ComplexityLevel): Int {
        val MINIMUM_XP_FACTOR = 0.25 // Garante que o operador sempre ganhe no mínimo 25% do XP.
        ...
        // Ocorrências comuns sofrem um decaimento linear suave após a 5ª do dia, com um piso mínimo.
        val decayFactor = if (dailyCount > 5) {
            // Decai 3.75% para cada ocorrência após a 5ª, até um piso de 25%.
            maxOf(MINIMUM_XP_FACTOR, 1.0 - ((dailyCount - 5) * 0.0375))
        } else {
            1.0
        }
